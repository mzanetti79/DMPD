...
selection = {
    ...
    # XZh preselections
    "singleEle" : "isWtoEN && lepton1_pt>115 && lepton1_highptId && lepton1_relIso03<0.15",
    "singleMuo" : "isWtoMN && lepton1_pt>50 && lepton1_highptId && lepton1_looseId && lepton1_relIso04<0.15",
    "doubleEle" : "isZtoEE && lepton1_pt>115 && lepton2_pt>35 && lepton1_miniIso<0.1 && lepton2_miniIso<0.1",
    "doubleMuo" : "isZtoMM && (lepton1_highptId || lepton2_highptId) && lepton1_pt>50 && lepton2_pt>20 && lepton1_miniIso<0.2 && lepton2_miniIso<0.2",
    "noLeptons" : "met_pt>200 && nMuons==0 && nElectrons==0 && nTaus==0 && nPhotons==0 && fatjet1_chf>0.1 && fatjet1_nhf<0.8 && fatjet1_dPhi_met>2 && nJetsNoFatJet100<=2 && minDeltaPhi>2",
    # XZh
    "Zcut" : "Z_pt>200 && Z_mass>70 && Z_mass<110 && fatjet1_pt>200",
    "Wcut" : "kW_pt>200 && met_pt>60 && fatjet1_pt>200",
    "Topcut" : "maxCSVNoFatJet>0.890",
    "TopVetocut" : "maxCSVNoFatJet<0.890",
    "SRcut" : "(fatjet1_prunedMassCorr>105 && fatjet1_prunedMassCorr<145)",
    "SBcut" : "fatjet1_prunedMassCorr>30 && (fatjet1_prunedMassCorr<65 || fatjet1_prunedMassCorr>145)",
...
#    "Btag" : "(fatjet1_CSV1>0.605 || fatjet1_CSV2>0.605)",
    # 2 leptons
    "XZheebbInc" : "triggerEle && doubleEle && Zcut",
    "XZheebbSR" : "triggerEle && doubleEle && Zcut && Btag && SRcut",
    "XZheebbSB" : "triggerEle && doubleEle && Zcut && Btag && SBcut",
    "XZhmmbbInc" : "triggerMuo && doubleMuo && Zcut",
    "XZhmmbbSR" : "triggerMuo && doubleMuo && Zcut && Btag && SRcut",
    "XZhmmbbSB" : "triggerMuo && doubleMuo && Zcut && Btag && SBcut",
    # 1 lepton
    "XWhenbbInc" : "triggerEle && singleEle && Wcut",
    "XWhenbbSR" : "triggerEle && singleEle && Wcut && TopVetocut && Btag && SRcut",
    "XWhenbbSB" : "triggerEle && singleEle && Wcut && TopVetocut && Btag && SBcut",
    "XWhmnbbInc" : "triggerMuo && singleMuo && Wcut",
    "XWhmnbbSR" : "triggerMuo && singleMuo && Wcut && TopVetocut && Btag && SRcut",
    "XWhmnbbSB" : "triggerMuo && singleMuo && Wcut && TopVetocut && Btag && SBcut",
    # 0 leptons
    "XZhnnbbInc" : "triggerMET && noLeptons",
    "XZhnnbbSR" : "triggerMET && noLeptons && Btag && SRcut",
    "XZhnnbbSB" : "triggerMET && noLeptons && Btag && SBcut",
    #
    "XTopenSB" : "triggerEle && singleEle && Wcut && Topcut && Btag && SBcut",
    "XTopmnSB" : "triggerMuo && singleMuo && Wcut && Topcut && Btag && SBcut",
    #
