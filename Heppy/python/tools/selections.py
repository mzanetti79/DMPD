...
selection = {
    ...
    "hfDM1" : "HLT_BIT_HLT_PFMET170_NoiseCleaned_v && met_pt>200 && jet1_pt>50 && jet1_chf>0.1 && jet1_nhf<0.8 && jet1_dPhi_met>2 && ((nJets==1 && jet1_CSVR>0.890) || (nJets==2 && jet2_dPhi_met>2 && ((jet1_CSVR>0.890)+(jet2_CSVR>0.890) == 1))) && nElectrons==0 && nMuons==0",
    "hfDM2" : "HLT_BIT_HLT_PFMET170_NoiseCleaned_v && met_pt>200 && jet1_pt>50 && jet1_chf>0.1 && jet1_nhf<0.8 && jet1_dPhi_met>2 && jet2_pt>50 && jet2_dPhi_met>2 && ( (nJets==2 && ((jet1_CSVR>0.890)+(jet2_CSVR>0.890) == 2)) || (nJets==3 && jet3_dPhi_met>2 && ((jet1_CSVR>0.890)+(jet2_CSVR>0.890)+(jet3_CSVR>0.890) == 2)) ) && nElectrons==0 && nMuons==0",
    # W
    "WeInc" : "(HLT_BIT_HLT_Ele27_WPLoose_Gsf_v || HLT_BIT_HLT_Ele27_WP85_Gsf_v) && nElectrons==1 && lepton1_isElectron && lepton1_tightId && lepton1_pt>30",
    "WmInc" : "HLT_BIT_HLT_IsoMu27_v && nMuons==1 && lepton1_isMuon && lepton1_tightId && lepton1_pt>30 && lepton1_relIso04<0.12",
    "WCR" : "(HLT_BIT_HLT_IsoMu27_v && nMuons==1 && lepton1_isMuon && lepton1_tightId && lepton1_pt>30 && lepton1_relIso04<0.12 || ((HLT_BIT_HLT_Ele27_WPLoose_Gsf_v || HLT_BIT_HLT_Ele27_WP85_Gsf_v) && nElectrons==1 && lepton1_isElectron && lepton1_tightId && lepton1_pt>30)) && W_tmass>50 && W_tmass<160 && fakemet_pt>200 && jet1_pt>50 && jet1_chf>0.1 && jet1_nhf<0.8 && minDeltaPhi>2 && nJets<=3",
    # Z
    ...
    "TCR" : "HLT_BIT_HLT_IsoMu27_v && lepton1_isMuon!=lepton2_isMuon && lepton1_pt>30 && lepton2_pt>30 && lepton1_tightId && (lepton1_isElectron || lepton1_relIso04<0.12) && jet1_pt>50 && jet1_chf>0.1 && jet1_nhf<0.8 && minDeltaPhi>2 && nJets<=3",
    # XZh preselections
