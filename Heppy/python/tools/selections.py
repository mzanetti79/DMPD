...
selection = {
    ...
    # Cat
    "cat1" : "( jet1_pt>50 && jet1_chf>0.1 && jet1_nhf<0.8 && ((nJets==1 && jet1_CSVR>0.890) || (nJets==2 && ((jet1_CSVR>0.890)+(jet2_CSVR>0.890)==1))) )",
    "cat2" : "( jet1_pt>50 && jet1_chf>0.1 && jet1_nhf<0.8 && jet2_pt>50 && ((nJets==2 && ((jet1_CSVR>0.890)+(jet2_CSVR>0.890)==2)) || (nJets==3 && ((jet1_CSVR>0.890)+(jet2_CSVR>0.890)+(jet3_CSVR>0.890)==2))) )",
    # SR
    ...
    "WeCR" : "WeInc && W_tmass<160 && minDeltaPhi<0.5 && fakemet_pt>200 && (cat1 || cat2)",
    "WmCR" : "WmInc && W_tmass<160 && minDeltaPhi<0.5 && fakemet_pt>200 && (cat1 || cat2)",
    # Z
    ...
    "ZeeCR" : "ZeeInc && fakemet_pt>200 && minDeltaPhi<0.5 && (cat1 || cat2)",
    "ZmmCR" : "ZmmInc && fakemet_pt>200 && minDeltaPhi<0.5 && (cat1 || cat2)",
    # T
