...
selection = {
  ...
  "monoB" : "HLT_BIT_HLT_PFMET170_NoiseCleaned_v && met_pt>200 && jet1_pt>50 && jet1_chf>0.2 && jet1_nhf<0.7 && jet1_phf<0.7 && jet1_CSV>0.890 && ((nJets==1 && abs(jet1_dPhi_met)>2) || (nJets==2 && jet2_nhf<0.7 && jet2_phf<0.9 && abs(jet2_dPhi_jet1)<2.5 && jet2_CSV>0.890)) && nElectrons==0 && nTaus==0 && nPhotons==0", # && abs(H_dPhi_met)>2
  "hfDM1" : "HLT_BIT_HLT_PFMET170_NoiseCleaned_v && met_pt>200 && jet1_pt>50 && jet1_chf>0.2 && jet1_nhf<0.7 && jet1_phf<0.7 && jet1_dPhi_met>2 && ((nJets==1 && jet1_CSV>0.890) || (nJets==2 && jet2_dPhi_met>2 && ((jet1_CSV>0.890)+(jet2_CSV>0.890) == 1))) && nElectrons==0 && nPhotons==0",
  "hfDM2" : "HLT_BIT_HLT_PFMET170_NoiseCleaned_v && met_pt>200 && jet1_pt>50 && jet1_chf>0.2 && jet1_nhf<0.7 && jet1_phf<0.7 && jet1_dPhi_met>2 && jet2_pt>50 && jet2_dPhi_met>2 && ( (nJets==2 && ((jet1_CSV>0.890)+(jet2_CSV>0.890) == 2)) || (nJets==3 && jet3_dPhi_met>2 && ((jet1_CSV>0.890)+(jet2_CSV>0.890)+(jet3_CSV>0.890) == 2)) ) && nElectrons==0 && nPhotons==0",
  ...
  "Zmm" : "HLT_BIT_HLT_IsoMu27_v && lepton1_isMuon && lepton1_tightId && lepton1_pt>20 && lepton1_relIso04<0.12 && lepton2_isMuon && lepton2_pt>15 && Z_mass>70 && Z_mass<110",
  ...
  "Zee" : "HLT_BIT_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v && lepton1_isElectron && lepton1_tightId && lepton1_pt>30 && abs(lepton1_eta)<2.1 && lepton2_pt>20 && Z_mass>70 && Z_mass<110",
  ...
  "AddCR" : "jet1_pt>50 && jet1_CSV>0.890 && nJets<=3 && met_pt<100",
  # AZh (outdated)
