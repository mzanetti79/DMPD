...
parser.add_option("-s", "--sample", action="store", type="string", dest="sample", default="")
(options, args) = parser.parse_args()

if options.sample == '': 
    print "expected the name of a sample"
    print "=== DATA ==="
    for i in datasamples: print i
    print "===  MC  ==="
    for i in mcsamples: print i
    sys.exit()
