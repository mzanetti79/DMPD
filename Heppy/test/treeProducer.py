...
triggerAnalyzer= cfg.Analyzer(
    ...
    triggerBits={
        ...
        'MET'            : ['HLT_PFMET120_JetIdCleaned_BTagCSV0p72_v*', 'HLT_PFMET120_NoiseCleaned_BTagCSV07_v*', 'HLT_PFHT350_PFMET100_JetIdCleaned_v*', 'HLT_PFMET170_NoiseCleaned_v*', 'HLT_PFMET170_JetIdCleaned_v*', 'HLT_PFMET170_v*'],
        #'JET'            : ['HLT_PFJet260_v*'],
    },
#   processName='HLT',
#   outprefix='HLT'
...
for i in datasamples:
    sample[i] = cfg.Component(
        ...
        name    = i,
        json    = '%s/src/DMPD/Heppy/python/tools/JSON/Cert_246908-258714_13TeV_PromptReco_Collisions15_25ns_JSON.txt' % os.environ['CMSSW_BASE'],
