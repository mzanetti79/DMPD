...
globalEventVariables = [
    ...
    NTupleVariable('facrenWeightUp',       lambda x: getattr(x, "FacRenScaleUp", 1.), float, help='Factorization and Renormalization Weight Up'),
    NTupleVariable('facrenWeightDown',     lambda x: getattr(x, "FacRenScaleDown", 1.), float, help='Factorization and Renormalization Weight Down'),
...
SignalRegionTreeProducer= cfg.Analyzer(
    ...
    globalVariables = globalDMVariables + [
        ...
        NTupleVariable('T_mass', lambda x: getattr(x, "T_mass", -1.), float, help='best reconstructed Top mass'),
    ],
    globalObjects = {
...
for i in datasamples:
    ...
    sample[i] = cfg.Component(
        ...
        name    = i,
        json    = '%s/src/DMPD/Heppy/python/tools/JSON/Cert_246908-260627_13TeV_PromptReco_Collisions15_25ns_JSON_Silver_v2.txt' % os.environ['CMSSW_BASE'], # 2.26
...
testDataCompontent = cfg.Component(
        files   = [
            # SingleElectron_Run2015D-PromptReco-v4_Chunk277
...
#            'dcap://t2-srm-02.lnl.infn.it/pnfs/lnl.infn.it/data/cms//store/data/Run2015D/SingleElectron/MINIAOD/PromptReco-v4/000/259/813/00000/427D1E32-B57B-E511-83F4-02163E0121AB.root',
            # SingleMuon_Run2015D-PromptReco-v4_Chunk301
            ...
            'dcap://t2-srm-02.lnl.infn.it/pnfs/lnl.infn.it/data/cms//store/data/Run2015D/SingleMuon/MINIAOD/PromptReco-v4/000/260/575/00000/8C101C96-3684-E511-9CB2-02163E01433E.root',
        ],
        name    = "test",
        json    = '%s/src/DMPD/Heppy/python/tools/JSON/Cert_246908-260627_13TeV_PromptReco_Collisions15_25ns_JSON_Silver_v2.txt' % os.environ['CMSSW_BASE'], # 2.26
        #json    = '%s/src/DMPD/Heppy/python/tools/JSON/Cert_13TeV_16Dec2015ReReco_Collisions15_25ns_JSON_Silver.txt' % os.environ['CMSSW_BASE'], # 2.63
...
testMCCompontent = cfg.MCComponent(
        files   = [
            ...
            'dcap://t2-srm-02.lnl.infn.it/pnfs/lnl.infn.it/data/cms//store/mc/RunIISpring15MiniAODv2/TT_TuneCUETP8M1_13TeV-powheg-pythia8/MINIAODSIM/74X_mcRun2_asymptotic_v2_ext3-v1/10000/003964D7-D06E-E511-A8DA-001517F7F524.root',
        ],
        isMC    = True,
        name    = "test",
        splitFactor = 1,
