...
globalEventVariables = [
    ...
    NTupleVariable('weight_1',         lambda x: abs(x.LHE_weights[0].wgt/x.LHE_originalWeight) if hasattr(x, "LHE_weights") and len(x.LHE_weights)>0 else 1, int, help='LHE Weight Id 1'),
    NTupleVariable('weight_2',         lambda x: abs(x.LHE_weights[1].wgt/x.LHE_originalWeight) if hasattr(x, "LHE_weights") and len(x.LHE_weights)>1 else 1, int, help='LHE Weight Id 2'),
    NTupleVariable('weight_3',         lambda x: abs(x.LHE_weights[2].wgt/x.LHE_originalWeight) if hasattr(x, "LHE_weights") and len(x.LHE_weights)>2 else 1, int, help='LHE Weight Id 3'),
    NTupleVariable('weight_4',         lambda x: abs(x.LHE_weights[3].wgt/x.LHE_originalWeight) if hasattr(x, "LHE_weights") and len(x.LHE_weights)>3 else 1, int, help='LHE Weight Id 4'),
    NTupleVariable('weight_5',         lambda x: abs(x.LHE_weights[4].wgt/x.LHE_originalWeight) if hasattr(x, "LHE_weights") and len(x.LHE_weights)>4 else 1, int, help='LHE Weight Id 5'),
    NTupleVariable('weight_6',         lambda x: abs(x.LHE_weights[5].wgt/x.LHE_originalWeight) if hasattr(x, "LHE_weights") and len(x.LHE_weights)>5 else 1, int, help='LHE Weight Id 6'),
    NTupleVariable('weight_7',         lambda x: abs(x.LHE_weights[6].wgt/x.LHE_originalWeight) if hasattr(x, "LHE_weights") and len(x.LHE_weights)>6 else 1, int, help='LHE Weight Id 7'),
    NTupleVariable('weight_8',         lambda x: abs(x.LHE_weights[7].wgt/x.LHE_originalWeight) if hasattr(x, "LHE_weights") and len(x.LHE_weights)>7 else 1, int, help='LHE Weight Id 8'),
    NTupleVariable('weight_9',         lambda x: abs(x.LHE_weights[8].wgt/x.LHE_originalWeight) if hasattr(x, "LHE_weights") and len(x.LHE_weights)>8 else 1, int, help='LHE Weight Id 9'),
...
WControlRegionTreeProducer= cfg.Analyzer(
    ...
    collections = {
        ...
        'selectedMuons'       : NTupleCollection('muon', leptonType, 4, help='Muon collection'),
        'selectedElectrons'   : NTupleCollection('electron', leptonType, 4, help='Electron collection'),
        #'xcleanTaus'          : NTupleCollection('tau', tauType, 1, help='cleaned Tau collection'),
        #'xcleanPhotons'       : NTupleCollection('photon', photonType, 1, help='cleaned Photon collection'),
