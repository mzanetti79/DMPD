...
globalEventVariables = [
    ...
    NTupleVariable('weight_4',         lambda x: abs(x.LHE_weights[3].wgt/x.LHE_originalWeight) if hasattr(x, "LHE_weights") and len(x.LHE_weights)>3 else 1, float, help='LHE Weight Id 4'),
    NTupleVariable('weight_5',         lambda x: abs(x.LHE_weights[4].wgt/x.LHE_originalWeight) if hasattr(x, "LHE_weights") and len(x.LHE_weights)>4 else 1, float, help='LHE Weight Id 5'),
    NTupleVariable('weight_6',         lambda x: abs(x.LHE_weights[5].wgt/x.LHE_originalWeight) if hasattr(x, "LHE_weights") and len(x.LHE_weights)>5 else 1, float, help='LHE Weight Id 6'),
